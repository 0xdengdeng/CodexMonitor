        ...
        items: [
          {
            ...
            help: t("settings.shortcuts.pressNewDefault", {
              shortcut: formatShortcut("cmd+shift+m"),
            }),
          },
          {
            label: t("settings.shortcuts.cycleAccess"),
            draftKey: "access",
            settingKey: "composerAccessShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+shift+a") }),
          },
          {
            label: t("settings.shortcuts.cycleReasoning"),
            draftKey: "reasoning",
            settingKey: "composerReasoningShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+shift+r") }),
          },
          {
            label: t("settings.shortcuts.cycleCollaboration"),
            draftKey: "collaboration",
            settingKey: "composerCollaborationShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("shift+tab") }),
          },
          {
        ...
        items: [
          {
            ...
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+shift+p") }),
          },
          {
            label: t("settings.shortcuts.toggleGitSidebar"),
            draftKey: "gitSidebar",
            settingKey: "toggleGitSidebarShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+shift+g") }),
          },
          {
            label: t("settings.shortcuts.branchSwitcher"),
            draftKey: "branchSwitcher",
            settingKey: "branchSwitcherShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+b") }),
          },
          {
            label: t("settings.shortcuts.toggleDebugPanel"),
            draftKey: "debugPanel",
            settingKey: "toggleDebugPanelShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+shift+d") }),
          },
          {
            label: t("settings.shortcuts.toggleTerminalPanel"),
            draftKey: "terminal",
            settingKey: "toggleTerminalShortcut",
            help: t("settings.shortcuts.default", { shortcut: formatShortcut("cmd+shift+t") }),
          },
        ],
      },
      {
      ...
      {filteredGroups.length === 0 && (
        <div className="settings-empty">
          {normalizedSearchQuery
            ...
            : t("settings.shortcuts.noMatchGeneric")}
        </div>
      )}
    </SettingsSection>
  );
